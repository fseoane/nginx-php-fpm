#FROM php:8.2.7-fpm-alpine3.19
#FROM php:8.2.16RC1-fpm-alpine3.19
FROM php:8.3.2-fpm-alpine3.19

LABEL maintainer="Fernando Seoane <fseoane@hotmail.com>"
...
RUN apk add --no-cache --virtual .sys-deps \
  ...
  # Install composer and certbot
    ...
    apk del libffi-dev augeas-dev python3-dev make autoconf && \
    apk del .sys-deps
